  ...
  var Dialog = function () {
    ...
    this.showLinkDialog = function ($editable, $dialog, linkInfo) {
      return $.Deferred(function (deferred) {
        ...
        $linkSelect = $linkDialog.find('.note-link-select'),
        ...
        $linkDialog.one('shown.bs.modal', function () {
          ...
          if ($linkSelect.length)
          {
              $linkSelect.on('change', function () {
                  $linkText.val($(this).find('option:selected').text());
    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplLinkDialog = function () {
          ...
          var linkOptions = function ()
          {
              ...
              for(var i=0; i<options.linksArray.length; i++)
              {
                  ret += "<option value='"+options.linksArray[i]['value']+"'>"+options.linksArray[i]['text']+"</option>";
              }
              return ret;
          };
        ...
        var body = '<div class="form-group">' +
                   ...
                   (options.linksArray ?
                       '<div  class="form-group">' +
                       '<label>' + lang.link.attachments + '</label>' +
                       '<select class="note-link-select form-control span12" >' + linkOptions() +
                       '</select>' +
                       '</div>' : ''
                   );
