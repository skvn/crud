  ...
  publicMethods = {
    pushTag: function (tag, ignoreEvents, externalTagId) {
      ...
      if (alreadyInList) {
        ...
        html = '<span class="' + privateMethods.tagClasses.call($self) + '" id="' + newTagId + '" style="margin-right:5px;">';
        html += '<span>' + escaped + '</span>';
        html += '&nbsp;&nbsp;<a href="#" class="text-danger" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
